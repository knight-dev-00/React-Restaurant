      ...
      <div className="container">
        ...
        <div className="row row-content">
          ...
          <div className="col-12 col-sm-4 offset-sm-1">
            ...
            <address>
              Paris, France<br />
              <i className="fa fa-phone"></i>: +987 6543 2100<br />
              <i className="fa fa-fax"></i>: +987 6543 2100<br />
              <i className="fa fa-envelope"></i>: <a href="mailto:contact@ratatouille.net">contact@ratatouille.net</a>
            </address>
          </div>
          ...
          <div className="col-12 col-sm-11 offset-sm-1">
            <div className="btn-group" role="group">
              ...
              <a role="button" className="btn btn-success" href="mailto:contact@ratatouille.net"><i className="fa fa-envelope-o"></i> Email</a>
            </div>
          </div>
        </div>
        <div className="row row-content">
